namespace Recommendations
{
    ...
    public class RecommendationsApiWrapper
    {
        ...
        public OperationInfo<BuildInfo> WaitForBuildCompletion(string locationHeader)
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine(" Build Status: {1}. \t Will check again in 10 seconds.", operationInfo.PercentComplete, operationInfo.Status);
